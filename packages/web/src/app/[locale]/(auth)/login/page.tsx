...
import { Diamond, Github, Mail, ArrowRight, Loader2 } from "lucide-react"
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="bg-surface-dark border border-white/5 py-3 rounded-xl flex items-center justify-center gap-2 hover:bg-white/5 transition-all text-sm font-bold text-white">
