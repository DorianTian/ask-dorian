...
> Dorian 发现你周三有一个 OKR 对齐会，还有一个未完成的"准备 OKR 报告"任务。它不会创建新东西，而是说：
> *"发现 2 个相关项 → [开始准备报告] [提醒我会议] [其他意思...]"*

**示例 2: 你输入 "3点 老板 增长"**

> Dorian 推断：今天下午3点，老板召集的用户增长讨论会。但检测到冲突 — 3:00-4:00 已有专注时间。
> *"已创建会议 + 冲突提醒 → [把专注时间移到4点] [保留两个]"*
...
> Dorian 理解"生日"的完整含义：
> - 创建全天事件
> - 创建前置任务链：买礼物、订蛋糕（截止前一天）
> - 设置年度循环事件
> - 添加当天早上发祝福的提醒

**示例 5: "那个方案不行"**

> Dorian 在上下文中找到最近讨论过的多个"方案"，但无法确定是哪个：
> *"你说的是哪个方案？ [CDC 迁移方案] [首屏优化方案] [其他]"*

## 为什么选 Ask Dorian

|  | 笔记工具 (Notion) | 任务工具 (Todoist) | AI 聊天 (ChatGPT, Claw) | **Ask Dorian** |
|---|---|---|---|---|
| 输入 | 手动建页面 | 手动加任务 | 写完整提示词 | **任意输入** — 文字、语音、截图、链接，甚至两个字 |
| 理解能力 | 无 | 无 | 回答问题 | **上下文感知** — 了解你的项目、任务、日程 |
| 输出 | 你自己整理 | 你自己整理 | 聊天回复 | **可执行事项** — 任务、日程、知识，自动关联 |
| 冲突检测 | 无 | 无 | 无 | **内置** — 日历冲突、优先级矛盾、遗忘检测 |
| 闭环跟进 | 你来跟踪 | 基础提醒 | 无 | **全闭环** — 规划 → 执行 → 回顾 → 学习 |
| 学习成本 | 高 | 中 | 低 | **零** |

**别人说"你来整理"。我们说"丢进来，Dorian 帮你整理"。**

## 核心能力

### 随时随地捕获
文字、语音、文档、截图、链接 — 一个统一入口。桌面端 `Cmd+K`，移动端 PWA，还有邮件、iOS 快捷指令、微信多种方式。

### 五层 AI 处理管道
1. **理解** — 语义分析 + 意图识别，不只是关键词匹配
...
### 今日驾驶舱
你的每日指挥中心。任务、日程、Dorian 处理结果 — 一个页面搞定。记录想法不需要离开当前页面。

### 晨间规划 & 日终回顾
每天以清晰的计划开始。每天以回顾结束 — 完成了什么、延期了什么、做了哪些决策。

### 周复盘
自动生成周报：已完成、延期项、关键决策、知识沉淀。不需要手动写。

### 智能项目
碎片自动关联到项目。看板视图跟踪进度。每一条信息都有归处。
...
**一人公司、独立开发者、自媒体创作者、知识工作者** — 每天身兼多职，被碎片信息淹没，却没有助理帮忙整理的人。
...
| 方案 | 包含 |
|------|------|
| **免费版** | 每月 50 条碎片，基础 AI 处理 |
| **Pro** | 无限碎片，完整 AI 管道，全部集成 |
| **团队版** | 多人协作，共享项目，团队洞察 |
...
<p align="center">
  <strong>Stop organizing. Start doing. / 别再整理了。开始做事。</strong><br/>
